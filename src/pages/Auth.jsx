...
export default function Auth() {
  ...
  // Kept as attachment points on their sections (see JSX below); no longer
  // read anywhere now that the snap-to-section assist has been removed.
  ...
  return (
    <Box sx={{
      ...
      >
        ...
        <Box ref={heroRef} sx={{ textAlign: "center", px: { xs: 3, md: 6 }, pt: { xs: 6, md: 8 }, pb: { xs: 2.5, md: 3 } }}>
        ...
        {/* BOTTOM CTA */}
        <Box ref={bottomRef} sx={{ textAlign: "center", px: 3, py: { xs: 10, md: 14 } }}>
